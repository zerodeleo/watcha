...
export const wrapper = 'flex justify-center align-center';
export const p = 'fade-in ls-2 font-center w-p-100';
export const pName = 'capitalize';
export const pFooter = 'color-b02 m-20';
export const h1 = 'z-500 sticky top left right font-center font-stalemate fs-5 ls-1 p-20 color-b06 mt-30';
...
export const Globe = 'sticky top left right z-500 fs-3 mb-15';
export const Chat = 'bg z-400 fixed bottom left right p-25 mt-150';
export const TextArea = 'hidden sticky bottom pl-20 pr-20 br-15 bs-28i h-50 w-p-100 scroll color-b08 font-red-hat mt-10';
